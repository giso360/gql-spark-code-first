...
import com.wh.enums.EWhAction;
import com.wh.exceptions.*;
import com.wh.model.Property;
import com.wh.model.PropertyUnit;
import com.wh.model.PropertyUnitInput;
import com.wh.model.ReportingObject;
import com.wh.util.PropertyUnitConverter;
...
public class WhDb implements WhRepository {
    ...
    private static final ClassPathResource WH_DB_RESOURCE = new ClassPathResource("./data/wh_data.json");
